package my.cloud.notify.modules.nms.service.impl;
...
import my.cloud.notify.modules.nms.mapper.NmsNotificationLogMapper;
...
//    @Override
//    public Page<NmsNotificationLog> getNotificationLogAndCate(Integer status,String keyword, String name,String beginTime,String endTime, Integer pageSize, Integer pageNum) {
//
//        Page<NmsNotificationLog> page = new Page<>(pageNum, pageSize);
//        QueryWrapper<NmsNotificationLog> wrapper = new QueryWrapper<NmsNotificationLog>();
//        wrapper.orderByDesc("create_time");
//        LambdaQueryWrapper<NmsNotificationLog> lambda = wrapper.lambda();
//
//        log.info("status: {}",status);
...
//
//        return page(page, wrapper);
////        return this.baseMapper.getNotificationLogAndCate();
//    }
